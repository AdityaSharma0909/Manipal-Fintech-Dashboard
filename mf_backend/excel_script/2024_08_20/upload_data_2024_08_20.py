...
excel_file = pd.ExcelFile("./excel_script/2024_08_20/sheet3.xlsx")
sheet1 = "New List"
...
class UploadExcelToDB:
    ...
    def replace_role(self, raw_role, raw_product):
        ...
        elif "il" in processed_product and "sales manager" in processed_role or "team leader" in processed_role or "state head" in processed_role or "backend operations" in processed_role or "relationship manager" in processed_role:
            output_role = ROLES.RELATIONSHIP_MANAGER.value
...
exec(open('excel_script/2024_08_20/upload_data_2024_08_20.py').read())
"""