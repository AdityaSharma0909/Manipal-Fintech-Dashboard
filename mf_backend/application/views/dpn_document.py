...
from application.services.dpn_service import DpnPdfGeneration,DpnEsignUtil
...
class DpnEsign(ApiFramework):
    ...
    def process(self):
        return DpnEsignUtil().process_esign(self.__application_id , self.__user)


class DpnEsignView(APIView):

    def post(self, request):
        return DpnEsign(data=request.data , user=request.user).main()